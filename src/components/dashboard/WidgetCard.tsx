...
export default memo(function WidgetCard({ title, icon, badge, children, className = '', defaultCollapsed = false }: WidgetCardProps) {
  ...
  return (
    <div className={clsx('group relative overflow-hidden rounded-[30px] border border-border bg-surface/80 p-5 shadow-xl shadow-black/5 backdrop-blur-xl transition-all duration-300 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/10', className)}>
