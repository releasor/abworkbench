...
export function HabitStats({
  ...
  return (
    <GlassCard borderRadius={32} className="dashboard-panel overflow-hidden">
                ...
                <div
                  ...
                  className={clsx(
                    'flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs transition-all',
                      ...
                      : 'interactive-glass border-transparent text-text-muted',
                  )}
                >
...
function StatCard({
  ...
  return (
    <GlassCard borderRadius={22} className="dashboard-panel p-4">
      <div className={clsx('mb-3 flex h-9 w-9 items-center justify-center rounded-2xl bg-white/10', accent)}>
        {icon}
      </div>
