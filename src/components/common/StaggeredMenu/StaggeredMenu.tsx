...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  // Drive open/close animations from open state (works for controlled + uncontrolled)
  ...
  }, [open, onMenuOpen, onMenuClose, playOpen, playClose, animateIcon, animateColor, animateText])
